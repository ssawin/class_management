...
print(process_list_entry('#2+3+"a quote"-7#'))
print(process_list_entry('this; is a; simple; list'))
print(process_list_entry('this; is a; "more complicated"; list'))
print(process_list_entry('this list ; has a #python code#; piece to it'))
print(process_list_entry('this list; has #a lot ; of crazy#; "shit"; in it'))
print(process_list_entry('this list; has #all "sorts; of"  c;r;a;z;y#; "shit"; in it'))
print(process_list_entry('this list; has #all "sorts; of" \# c;r;a;z;y#; "shit"; in it'))
print(process_list_entry('surely; this "fool;ish "so \" called"; example; will #screw; up; \; "the \#; interpreter"#; with silliness'))
print(process_list_entry('#this has an error'))
